...
Pagodacoin is a lite version of Bitcoin using scrypt as a proof-of-work algorithm.
...
Pagodacoin is released under the terms of the MIT license. See `COPYING` for more
...
If it is a simple/trivial/non-controversial change, then one of the Pagodacoin
